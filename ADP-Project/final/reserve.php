...
<?php
    ...
    if($seat<4)
    { $flag=1;
       $row1 = $conn->query("select user_name from Stuff ");
    ...
    echo "$pass";
     ...
     $password = "SELECT password FROM Stuff WHERE user_name='$username'";
    $abc2 = $conn->query($password);
    $pass;
    ...
    echo "$pass";
    	...
    	$row1 ="INSERT INTO Reservation_log (passanger_name,user_name,source,time,DateofJourney,seat_no,vehicle) VALUES ('$name','$username','$source','$time','$date',$seat,'$bus')";
